...
# workOS Data Source Configuration

## Knowledge File Access Configuration

### Primary Knowledge Store
**Location**: `2-knowledgebase/-common/`
...
```
Knowledge Files:
- People profiles: 2-knowledgebase/-common/People/
- Meeting notes: 2-knowledgebase/-common/Knowledge/
- Business assets: 2-knowledgebase/-common/business-assets/
- Context blocks: 2-knowledgebase/-common/context-blocks/
- Daily notes: 2-knowledgebase/-common/daily-notes/
- Tasks: 2-knowledgebase/-common/Tasks/
- Shared content: 2-knowledgebase/-common/shared-content/
```
...
1. **Primary source**: Read from `2-knowledgebase/-common/[category]/`
...
1. **Target location**: Write to appropriate folder in `2-knowledgebase/-common/`
...
- `create_knowledge`: Write to `2-knowledgebase/-common/Knowledge/`
- `update_knowledge`: Update files in `2-knowledgebase/-common/Knowledge/`
- `search_knowledge`: Search across `2-knowledgebase/-common/`
...
- `create_person`: Write to `2-knowledgebase/-common/People/`
- `update_person`: Update files in `2-knowledgebase/-common/People/`
...
- Task files: Write to `2-knowledgebase/-common/Tasks/`
...
1. **Check directory access**: Verify `2-knowledgebase/-common/` is accessible
...
- [ ] Can read from `2-knowledgebase/-common/People/`
- [ ] Can read from `2-knowledgebase/-common/Knowledge/`
- [ ] Can read from `2-knowledgebase/-common/business-assets/`
- [ ] Can read from `2-knowledgebase/-common/context-blocks/`
- [ ] Can read from `2-knowledgebase/-common/Tasks/`
- [ ] Can write to `2-knowledgebase/-common/` (test file creation/deletion)
...
- `1-projects/-agents/workOS/Knowledge/` → Use `2-knowledgebase/-common/Knowledge/`
- `1-projects/-agents/workOS/People/` → Use `2-knowledgebase/-common/People/`
- `1-projects/-agents/workOS/Tasks/` → Use `2-knowledgebase/-common/Tasks/`
- `1-projects/-agents/workOS/daily-notes/` → Use `2-knowledgebase/-common/daily-notes/`
...
New path: 2-knowledgebase/-common/Knowledge/[filename]
