...
- **Tasks/**: Individual task files with YAML frontmatter (stored in consolidated knowledgebase at `knowledgebase/-common/Tasks/`)
- **Knowledge/**: Reference documents, meeting notes, specs (stored in consolidated knowledgebase at `knowledgebase/-common/Topics/`)
- **People/**: Person profiles and relationship context (stored in consolidated knowledgebase at `knowledgebase/-common/People/`)
...
**Note**: All MCP tools now access the consolidated knowledgebase at `knowledgebase/-common/` instead of local directories. See `data-sources.md` for configuration details.
...
- Optional: due_date, resource_refs (links to consolidated knowledgebase files)
...
Link to relevant files in consolidated knowledgebase for background.
