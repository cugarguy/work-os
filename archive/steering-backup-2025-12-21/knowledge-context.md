...
**IMPORTANT**: Knowledge files are now stored in the consolidated knowledgebase at `knowledgebase/-common/Knowledge/`. See `data-sources.md` for complete configuration.

When working with knowledge files:

## Purpose

Knowledge/ stores (in consolidated knowledgebase at `knowledgebase/-common/Knowledge/`):
